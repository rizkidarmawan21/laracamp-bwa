...
<body>
    ...
    <section class="pricing">
        <div class="container">
            ...
            <div class="row pb-70" ">
                <div class="col-lg-12 col-12 text-center">
                    <marquee behavior="" direction=""><img src="/assets/images/brands.png" height="30" alt=""></marquee>
                </div>
            </div>
        </div>
    </section>
                  ...
                  <div class="col-lg-3 col-md-6">
                      <div class="">
                          <div class="list-space">
                              <img src="https://kawan-data.herokuapp.com/images/icon_putih.png" alt="Logo" width="45px"
                                  height="45px" />
                          </div>
